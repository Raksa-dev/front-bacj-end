export const layer1_male_ascendants = {
  ...
  'Capricorn Ascendant': {
    description:
      'Chris is the embodiment of ambition and discipline. He has a strong sense of duty and a practical approach to achieving his goals. Reserved and responsible, Chris often takes on leadership roles, guiding others with his methodical planning. He values tradition and structure, and his perseverance ensures he always reaches his objectives. Chris’s goal-oriented mindset and reliability make him a respected figure in any setting.',
    Hollywood: [
...
export const layer1_female_ascendants = {
  ...
  'Capricorn Ascendant': {
    description:
      'Chris is the embodiment of ambition and discipline. She has a strong sense of duty and a practical approach to achieving her goals. Reserved and responsible, Chris often takes on leadership roles, guiding others with her methodical planning. She values tradition and structure, and her perseverance ensures she always reaches her objectives. Chris’s goal-oriented mindset and reliability make her a respected figure in any setting.',
    Hollywood: [
  ...
  'Aquarius Ascendant': {
    ...
    Hollywood: ["Luna Lovegood from 'Harry Potter'", "Amélie from 'Amélie'"],
    Bollywood: [
  ...
  'Pisces Ascendant': {
    ...
    Hollywood: ["Amélie Poulain from 'Amélie'", "Rapunzel from 'Tangled'"],
    Bollywood: [
