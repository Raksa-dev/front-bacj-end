...
export class NewlandingpageComponent {
  ...
  public testimonials: Testimonial[] = [
    {
      _id: 1,
      userName: 'Sannidhi Sompalli',
      age: 30,
      avatar: '../../../assets/images/testimonial/sannidhi.sompalli.jpg',
      address: ' Assam, India',
    ...
    {
      _id: 2,
      avatar: '../../../assets/images/testimonial/lalima.hindocha.jpg',
      userName: 'Lalima Hindocha',
      age: 28,
    ...
    {
      _id: 3,
      avatar: '../../../assets/images/testimonial/shali.mandaraa.jpg',
      userName: 'Shali Mandaraa',
      age: 27,
